        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col">
                    ...
                    <table class="table table-dark table-responsive table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            ?>
                            <?php
                            if (mysqli_num_rows($all_inactive_techn_orders) == 0) {
                                echo '<td colspan=10>Neaktyvių taisymų nėra!</td>';
                            }
                            ?>
                        </tbody>
                    </table>
                ...
                <div class="col">
                    ...
                    <table class="table table-dark table-responsive table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <?php
                            if (mysqli_num_rows($all_active_techn_orders) == 0) {
                                echo '<td colspan=10>Aktyvių taisymų nėra!</td>';
                            }
                            ?>
